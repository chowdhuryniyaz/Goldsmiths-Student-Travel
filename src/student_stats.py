...
ax1.text(0, -0.15, 'UK: {:.0f}%'.format(x1_x), fontdict={'color':'#004c6d', 'fontweight':'heavy', 'fontsize':12})
ax1.text(w2, -0.15, 'EU: {:.0f}%'.format(x2_x), fontdict={'color':'#449cb7', 'fontweight':'heavy', 'fontsize':12, 'horizontalalignment':'right'})
ax1.text(w2, -0.25, 'overseas: {:.0f}%'.format(x3_x), fontdict={'color':'#8bf3ff', 'fontweight':'heavy', 'fontsize':12, 'horizontalalignment':'right'})
# hide axis
ax1.axis('off')
...
ax2.text(0, -0.15, 'Undergraduate: {:.0f}%'.format(x4_x), fontdict={'color':'#004c6d', 'fontweight':'heavy', 'fontsize':12})
ax2.text(w2, -0.15, 'Postgraduate: {:.0f}%'.format(x5_x), fontdict={'color':'#449cb7', 'fontweight':'heavy', 'fontsize':12, 'horizontalalignment':'right'})
ax2.text(w2, -0.25, 'Foundation: {:.0f}%'.format(x6_x), fontdict={'color':'#8bf3ff', 'fontweight':'heavy', 'fontsize':12, 'horizontalalignment':'right'})
# hide axis
ax2.axis('off')
...
# plot values as stacked bar
mode_pct.plot(ax = ax3,kind='barh', stacked=True, rot=0, width=0.1, color=['#004c6d','#449cb7'], legend=None)
...
ax3.text(0, -0.15, 'Full time: {:.0f}%'.format(x7_x), fontdict={'color':'#004c6d', 'fontweight':'heavy', 'fontsize':12})
ax3.text(w2, -0.15, 'Part time: {:.0f}%'.format(x8_x), fontdict={'color':'#449cb7', 'fontweight':'heavy', 'fontsize':12, 'horizontalalignment':'right'})
# hide axis
ax3.axis('off')
